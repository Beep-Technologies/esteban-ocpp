...
// meterValues handles the Meter Values operation, initiated by the charge point
func (c *OCPP16ChargePoint) meterValues(req *msg.OCPP16CallMessage) (*msg.OCPP16CallResult, *msg.OCPP16CallError) {
	b := &ocpp16.MeterValuesRequest{}
